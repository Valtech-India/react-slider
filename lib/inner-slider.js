...
var InnerSlider = exports.InnerSlider = function (_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _this.touchStart = function(e){
      ...
      _this.firstClientY = e.touches[ 0 ].clientY;
    }

    _this.preventTouch = function(e){
      const minValue = 5; // threshold

      _this.clientX = e.touches[ 0 ].clientX - _this.firstClientX;
      _this.clientY = e.touches[ 0 ].clientY - _this.firstClientY;
    ...
    _this.componentDidMount = function () {
      ...
      if(userAgent.match(/iPhone/i)){
        var index = userAgent.split(" ").indexOf("OS") + 1
